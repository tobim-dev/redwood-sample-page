...
const ContactForm = () => {
  return (
    <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto mt-6 text-gray-900 bg-gray-100 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 m-6 rounded-lg shadow">
      ...
      <div>
        ...
        <div className="mt-8">
          ...
          <textarea className="w-full h-32 p-3 mt-2 text-gray-900 bg-gray-300 rounded-lg focus:outline-none focus:shadow-outline" />
        </div>
        <div className="mt-8">
